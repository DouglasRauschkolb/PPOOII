...
public class Vetor<T> {
	...
	public boolean adicionar(T l_elemento){
	...
	public boolean adicionarEmPosicao(int l_posicao, T l_elemento){
	...
	public T buscaValor(int l_posicao) {
		if (!(l_posicao >=0 && l_posicao < tamanho)){
			throw new IllegalArgumentException("Posicao invalida");
		}
	...
	public int buscaPosicao(T l_elemento) {
	...
	public Vetor(int l_capacidade){
		this.elementos =  (T[]) new Object[l_capacidade];
		this.tamanho = 0;
	}
